 ...
 */
public final class CommandStaffReply extends AbstractCommand {

    /**
     * Creates the command.
     */
    public CommandStaffReply() {
        super("staffreply", Rank.MOD, Target.PLAYER, "staffr", "sr");
    }

    /**
     * Replies to the last staff message.
     * @param context The context.
     */
    @Override
    public void execute(NexusCommandContext context) {
        Bukkit.dispatchCommand(context.getSender(), "staffmessage ! " + String.join(" ", context.getArgs()));
    }
