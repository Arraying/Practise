 ...
 */
public final class CommandRules extends AbstractCommand {

    /**
     * Creates the command.
     */
    public CommandRules() {
        super("rules", Rank.DEFAULT, Target.BOTH);
    }
    ...
    public void execute(NexusCommandContext context) {
        for(String line : Practise.getPractise().getConfig().getStringList("rules")) {
            context.reply(ChatColor.translateAlternateColorCodes('&', line));
        }
    }
